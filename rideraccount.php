<?php 
    ...
    $sql = "SELECT u.user_id, username, email, role_id, firstname, lastname, address, contact_number,drivers_license FROM users u
                            ...
                            <div class="card-body">
                                <form id="riderForm" action="process_registerrider.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" required placeholder="Enter rider's address">
                                    </div>
