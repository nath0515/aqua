...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="d-flex justify-content-end mb-3">
                            ...
                            <button id="downloadPDFBtn" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="Download Report as PDF">
        ...
        <div id="reportToDownload" style="display: none;">
